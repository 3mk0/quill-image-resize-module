...
var Resize = function (_BaseModule) {
    ...
    function Resize() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resize.__proto__ || Object.getPrototypeOf(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
            ...
            _this.preDragHeight = _this.img.height || _this.img.naturalHeight;
            ...
            if (!_this.quill.root.parentElement.contains(evt.target)) {
            ...
            if (Math.round(deltaX) !== 0) {
                var originalRatio = _this.preDragWidth / _this.preDragHeight;
                ...
                _this.img.height = Math.round(_this.img.width / originalRatio);
                _this.requestUpdate();
            }
...
var Toolbar = function (_BaseModule) {
    ...
    function Toolbar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function (parchment) {
            // Parchment = parchment;
        ...
        }, _this._triggerUpdate = function () {
            // Dirty, but does the trick
            _this.img.width = _this.img.width + 1;
